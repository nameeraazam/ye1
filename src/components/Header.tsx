  ...
  return (
    <header className="text-gray-600 body-font bg-white shadow-md">
      <div className="container mx-auto flex p-3 justify-between items-center px-4 sm:px-6 md:px-8">
        {/* Logo Section */}
        <h1 className="sm:text-2xl text-xl mt-2 font-bold text-gray-900 mb-4 md:mb-0">BLOG</h1>

        {/* Navigation Links for Desktop */}
        <nav className="md:ml-auto md:mr-auto flex-wrap items-center text-base justify-center space-x-5 hidden md:flex">
          <Link href="/" className="mr-5 hover:text-blue-500 text-lg font-bold">Home</Link>
          <Link href="/contact" className="mr-5 hover:text-gray-900 text-lg font-bold">Contact</Link>
          <Link href="/about" className="mr-5 hover:text-gray-900 text-lg font-bold">About</Link>
        </nav>
